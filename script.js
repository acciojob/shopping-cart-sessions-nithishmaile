...
const cartList=document.getElementById("cart-list");
        ...
        //     renderCart(JSON.parse(sessionStorage.getItem("cartData")))
        // }
        ...
        // for(let data of JSON.parse(sessionStorage.getItem("cartData"))){
        //     const li=document.createElement("li");
        //     li.innerHTML=`<p>${data.name} </p> <p>$${data.price}</p> <button type="button" id=${data.id} onClick="removeFromCart(event)">Remove</button>`
        //     cartList.appendChild(li)
        // }
